...
(9, 'Dans les rivières', TRUE, 3),
(10, 'Dans les océans', FALSE, 3),
(11, 'Dans les mers', FALSE, 3),
(12, 'Dans les déserts', FALSE, 3),

(13, 'Pour la photosynthèse', TRUE, 4),
(14, 'Pour produire du nectar', FALSE, 4),
(15, 'Pour attirer les insectes', FALSE, 4),
(16, 'Pour se protéger du soleil', FALSE, 4),

(17, 'Non', TRUE, 5),
(18, 'Oui', FALSE, 5),
(19, 'Parfois', FALSE, 5),
(20, 'Seulement avec du sel', FALSE, 5),
...
(25, 'Océan Pacifique', TRUE, 7),
(26, 'Océan Atlantique', FALSE, 7),
(27, 'Océan Indien', FALSE, 7),
(28, 'Océan Arctique', FALSE, 7),
...
(33, 'Les glaciers', TRUE, 9),
(34, 'Les mers', FALSE, 9),
(35, 'Les océans', FALSE, 9),
(36, 'Les lacs salés', FALSE, 9),
...
(45, 'Cycle de l’eau', TRUE, 12),
(46, 'Cycle du carbone', FALSE, 12),
(47, 'Cycle de l’azote', FALSE, 12),
(48, 'Cycle du soufre', FALSE, 12),

(49, 'Le Nil', TRUE, 13),
(50, 'L’Amazone', FALSE, 13),
(51, 'Le Yangtsé', FALSE, 13),
(52, 'Le Mississippi', FALSE, 13),
...
(65, 'Elle s’évapore', TRUE, 17),
(66, 'Elle gèle', FALSE, 17),
(67, 'Elle se condense', FALSE, 17),
(68, 'Elle disparaît', FALSE, 17),
...
(205,'Elles abritent de nombreuses espèces', TRUE, 52),
(206,'Elles sont belles', FALSE, 52),
(207,'Elles sont faciles à drainer', FALSE, 52),
(208,'Elles produisent du sel', FALSE, 52),

(209,'En érodant le sol', TRUE, 53),
(210,'En construisant des montagnes', FALSE, 53),
(211,'En filtrant l’eau', FALSE, 53),
(212,'En absorbant l’eau', FALSE, 53),

(213,'Zones côtières tropicales', TRUE, 54),
(214,'Déserts', FALSE, 54),
(215,'Montagnes', FALSE, 54),
(216,'Forêts tempérées', FALSE, 54),

(217,'Elles enrichissent le sol en nutriments', TRUE, 55),
(218,'Elles retiennent l’eau', FALSE, 55),
(219,'Elles protègent des inondations', FALSE, 55),
(220,'Elles fournissent de l’ombre', FALSE, 55);
